        ...
        NavigationStack {
            ZStack {
                ...
                VStack(alignment: .leading) {
                    if displayMode == "liste" { // Le titre ne s'affiche que si on est en mode liste
                    ...
                    HStack(spacing: 0) {
                        Button {
                            ...
                            Text("liste")
                                ...
                                .padding(.vertical, 10)
                                .background(displayMode == "liste" ? Color.orange : Color.white)
                        ...
                        Button {
                            ...
                            Text("carte")
                                ...
                                .frame(maxWidth: .infinity)
                                .padding(.vertical, 10)
                                .background(displayMode == "carte" ? Color.orange : Color.white)
                                .foregroundColor(.black)
                        }
                    }
                        .frame(height: 38)
